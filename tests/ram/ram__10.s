;
; XMBurner test - xmb_ram.s, case 10
;
...
;
;
; Tests whether an increment fault of a pointer is caught.
;
...
main:
	...
	MOD_INCDEC_R16 RAMSTART + 255, 0x23 ; LD(ptr+) doesn't increment for a value
	MOD_ENA_R16
