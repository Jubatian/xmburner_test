;
; XMBurner test - xmb_jump.s, case 46
;
...
;
;
; Tests RJMP/RCALL negative bit 5 clear never jumping on xmb_jump_branch.
;
...
main:
	...
	MOD_NOP_R16    0xE820, 0xC800 ; RJMP/RCALL variant turned into NOP
	MOD_ENA_R16
