;
; XMBurner test - xmb_jump.s, case 35
;
...
;
;
; Tests RJMP/RCALL positive bit 4 set never jumping on xmb_jump_branch.
;
...
main:
	...
	MOD_NOP_R16    0xE810, 0xC010 ; RJMP/RCALL variant turned into NOP
	MOD_ENA_R16
