;
; XMBurner test - xmb_jump.s, case 45
;
...
;
;
; Tests RJMP/RCALL negative bit 4 set never jumping on xmb_jump_branch.
;
...
main:
	...
	MOD_NOP_R16    0xE810, 0xC810 ; RJMP/RCALL variant turned into NOP
	MOD_ENA_R16
