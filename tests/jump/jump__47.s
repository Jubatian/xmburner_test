;
; XMBurner test - xmb_jump.s, case 47
;
...
;
;
; Tests RJMP/RCALL negative bit 5 set never jumping on xmb_jump_branch.
;
...
main:
	...
	MOD_NOP_R16    0xE820, 0xC820 ; RJMP/RCALL variant turned into NOP
	MOD_ENA_R16
