;
; XMBurner test - xmb_jump.s, case 42
;
...
;
;
; Tests RJMP/RCALL negative bit 1 clear never jumping on xmb_jump_branch.
;
...
main:
	...
	MOD_NOP_R16    0xE802, 0xC800 ; RJMP/RCALL variant turned into NOP
	MOD_ENA_R16
