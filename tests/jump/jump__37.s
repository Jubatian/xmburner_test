;
; XMBurner test - xmb_jump.s, case 37
;
...
;
;
; Tests RJMP/RCALL positive bit 5 set never jumping on xmb_jump_branch.
;
...
main:
	...
	MOD_NOP_R16    0xE820, 0xC020 ; RJMP/RCALL variant turned into NOP
	MOD_ENA_R16
