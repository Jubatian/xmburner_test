;
; XMBurner test - xmb_jump.s, case 31
;
...
;
;
; Tests RJMP/RCALL positive bit 0 set never jumping on xmb_jump_branch.
;
...
main:
	...
	MOD_NOP_R16    0xE801, 0xC001 ; RJMP/RCALL variant turned into NOP
	MOD_ENA_R16
